...
var cfgFile string
var InputFlags = terminal.NewCmdFlags()
...
to quickly create a Cobra application.`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		//terminal.PromptInput(InputFlags)
		//terminal.Prompt()
		//redis.Connect(InputFlags)
		//terminal.AutoComp()
		terminal.Run(InputFlags)
	},
}
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".redic" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".redic")
	}
